...
import { Satellite, Globe, Shield, Terminal, Crosshair, Eye } from "lucide-react";
    ...
    >
      <div className="p-4 border-b border-[#1a331a] flex items-center gap-3">
        <div className="w-8 h-8 flex items-center justify-center flex-shrink-0">
          <svg viewBox="0 0 32 32" className="w-7 h-7 text-[#ffcc00]">
            <path 
              fill="currentColor" 
        ...
        {!collapsed && (
          <div>
            <div className="text-sm font-bold tracking-[4px] text-[#ffcc00] text-glow-amber">OSIRIS</div>
      ...
      <div className="px-3 py-2 border-b border-[#1a331a]">
        <div className="flex items-center gap-2">
          ...
          {!collapsed && (
            <span className="text-[10px] text-[#666] uppercase tracking-wider">System Online</span>
          )}
        </div>
      </div>
